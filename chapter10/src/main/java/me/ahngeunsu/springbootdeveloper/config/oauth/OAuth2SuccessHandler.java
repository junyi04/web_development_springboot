...
import me.ahngeunsu.springbootdeveloper.config.OAuth2AuthorizationRequestBasedOnCookieRepository;
...
/*
    UserService.java 로 넘어가기
    
    지금 현재 email 을 통한 유저 수정이 일어나고 있는 중입니다.
    OAuth 를 위한 로직이 어느정도 구현됐으므로 작선한 글에 글쓴이를 추가하는 작업
