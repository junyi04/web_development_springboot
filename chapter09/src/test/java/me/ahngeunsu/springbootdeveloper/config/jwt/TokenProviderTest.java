...
class TokenProviderTest {
    ...
    void validToken_invalidToken() {
        // given -> 일부러 default 가 아니라 실패하는 token 을 생성하기 때문에 위의 메서드와 반대
...
/*
    1. generateToken
        given : 토큰에 위치 정보를 추가하기 위한 테스트 유저 생성
    ...
    2.
        1) validToken_validToken
            ...
            when : 토큰 제공자와 (tokenProvider) validToken() 메서드를 호풀해 유효한 토큰인지 검증하고
                결과값을 boolean 값으로 변환
    ...
    3. getAuthentication()
        ...
        when : getAuthentication() 메서드 호출, 인증 객체를 반환
    ...
    4. getUserId()
        ...
        then : 반환 값은 유저 ID가 given 절에서 초기화한 1과 같은지 확인
